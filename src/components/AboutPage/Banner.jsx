						...
						<nav className="navbar navbar-default">
							...
							<div className="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
								<ul className="nav navbar-nav cl-effect-16">
									...
									<li><a href="about.html" className="active" data-hover="About">About</a></li> 
									<li><a href="#" className="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Pages <span class="caret"></span></a>
